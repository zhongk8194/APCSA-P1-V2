...
public class MadLib
{
	...
	public void loadNouns()
	{
		try{
			...
			Scanner file = new Scanner(new File ("C:\\Users\\zhongk8194)\\Documents\\GitHub\\APCSA-P1-V2\\Unit10\\src\\nouns.dat"));
	...
	{
		try{
			Scanner file = new Scanner(new File ("C:\\Users\\zhongk8194)\\Documents\\GitHub\\APCSA-P1-V2\\Unit10\\src\\verbs.dat"));
			while (file.hasNextLine()){
	...
	{
		try{
			Scanner file = new Scanner(new File ("C:\\Users\\zhongk8194)\\Documents\\GitHub\\APCSA-P1-V2\\Unit10\\src\\adjectives.dat"));
			while (file.hasNextLine()){
